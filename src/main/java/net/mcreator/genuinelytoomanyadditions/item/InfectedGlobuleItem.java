...
public class InfectedGlobuleItem extends SoeModElements.ModElement {
	@ObjectHolder("soe:infected_globule")
	public static final Item block = null;
	public InfectedGlobuleItem(SoeModElements instance) {
		super(instance, 106);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("infected_globule");
		}
