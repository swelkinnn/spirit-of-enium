...
public class BrutingCycleItem extends SoeModElements.ModElement {
	@ObjectHolder("soe:bruting_cycle")
	public static final Item block = null;
	public BrutingCycleItem(SoeModElements instance) {
		super(instance, 40);
	}
	...
	private static class ItemToolCustom extends Item {
		protected ItemToolCustom() {
			super(new Item.Properties().group(GMTToolsAndWeaponsItemGroup.tab).maxDamage(350));
		}
