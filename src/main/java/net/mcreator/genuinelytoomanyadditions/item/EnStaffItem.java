...
public class EnStaffItem extends SoeModElements.ModElement {
	@ObjectHolder("soe:en_staff")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("entitybulleten_staff").setRegistryName("entitybulleten_staff");
	public EnStaffItem(SoeModElements instance) {
		super(instance, 54);
		FMLJavaModLoadingContext.get().getModEventBus().register(new EnStaffRenderer.ModelRegisterHandler());
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(null).maxDamage(1000));
			setRegistryName("en_staff");
		}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(Items.HEART_OF_THE_SEA, (int) (1));
		}
