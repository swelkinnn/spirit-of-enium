...
import net.mcreator.genuinelytoomanyadditions.gui.VioletTomeGUIGuiWindow;
import net.mcreator.genuinelytoomanyadditions.gui.VioletTomeGUIGui;
...
public class VioletTomeItem extends SoeModElements.ModElement {
	@ObjectHolder("soe:violet_tome")
	public static final Item block = null;
	public VioletTomeItem(SoeModElements instance) {
		super(instance, 154);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof VioletTomeGUIGuiWindow) {
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Violet Tome");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new VioletTomeGUIGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
