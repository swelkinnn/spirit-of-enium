...
public class SteelHoeItem extends SoeModElements.ModElement {
	@ObjectHolder("soe:steel_hoe")
	public static final Item block = null;
	public SteelHoeItem(SoeModElements instance) {
		super(instance, 32);
	}
	...
	public void initElements() {
		elements.items.add(() -> new HoeItem(new IItemTier() {
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("\u00A77The best use of your steel"));
			}
