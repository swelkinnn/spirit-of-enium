...
public class SteelArmorItem extends SoeModElements.ModElement {
	@ObjectHolder("soe:steel_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("soe:steel_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("soe:steel_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("soe:steel_armor_boots")
	public static final Item boots = null;
	public SteelArmorItem(SoeModElements instance) {
		super(instance, 114);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(GTMArmorsItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "soe:textures/models/armor/steel__layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
