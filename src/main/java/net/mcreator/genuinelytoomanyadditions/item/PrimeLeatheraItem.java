...
public class PrimeLeatheraItem extends SoeModElements.ModElement {
	@ObjectHolder("soe:prime_leathera_helmet")
	public static final Item helmet = null;
	@ObjectHolder("soe:prime_leathera_chestplate")
	public static final Item body = null;
	@ObjectHolder("soe:prime_leathera_leggings")
	public static final Item legs = null;
	@ObjectHolder("soe:prime_leathera_boots")
	public static final Item boots = null;
	public PrimeLeatheraItem(SoeModElements instance) {
		super(instance, 652);
	}
	...
	public void initElements() {
		IArmorMaterial armormaterial = new IArmorMaterial() {
			...
			public Ingredient getRepairMaterial() {
				return Ingredient.fromStacks(new ItemStack(PrimeLeatherItem.block, (int) (1)));
			}

			@OnlyIn(Dist.CLIENT)
			@Override
			public String getName() {
				return "prime_leathera";
			}
