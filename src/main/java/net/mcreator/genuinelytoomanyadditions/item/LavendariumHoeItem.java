	...
	public void initElements() {
		elements.items.add(() -> new HoeItem(new IItemTier() {
			...
			public Ingredient getRepairMaterial() {
				return Ingredient.fromStacks(new ItemStack(LavendariumNuggetItem.block, (int) (1)),
						new ItemStack(LavendariumMeshItem.block, (int) (1)), new ItemStack(LavendariumIngotItem.block, (int) (1)));
			}
