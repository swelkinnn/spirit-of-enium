...
public class HemolyphBloodParticle extends SoeModElements.ModElement {
	public static final BasicParticleType particle = new BasicParticleType(false);
	public HemolyphBloodParticle(SoeModElements instance) {
		super(instance, 820);
	...
	public void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("hemolyph_blood"));
	}
