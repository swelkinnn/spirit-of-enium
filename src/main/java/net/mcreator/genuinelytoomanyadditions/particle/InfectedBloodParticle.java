...
public class InfectedBloodParticle extends SoeModElements.ModElement {
	public static final BasicParticleType particle = new BasicParticleType(false);
	public InfectedBloodParticle(SoeModElements instance) {
		super(instance, 817);
	...
	public void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("infected_blood"));
	}
