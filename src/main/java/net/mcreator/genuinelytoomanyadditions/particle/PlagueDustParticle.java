...
public class PlagueDustParticle extends SoeModElements.ModElement {
	public static final BasicParticleType particle = new BasicParticleType(true);
	public PlagueDustParticle(SoeModElements instance) {
		super(instance, 594);
	...
	public void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("plague_dust"));
	}
