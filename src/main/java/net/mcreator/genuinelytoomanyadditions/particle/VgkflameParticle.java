...
public class VgkflameParticle extends SoeModElements.ModElement {
	public static final BasicParticleType particle = new BasicParticleType(false);
	public VgkflameParticle(SoeModElements instance) {
		super(instance, 428);
	...
	public void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("vgkflame"));
	}
