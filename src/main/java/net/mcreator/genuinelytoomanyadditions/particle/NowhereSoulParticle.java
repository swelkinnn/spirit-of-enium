...
public class NowhereSoulParticle extends SoeModElements.ModElement {
	public static final BasicParticleType particle = new BasicParticleType(false);
	public NowhereSoulParticle(SoeModElements instance) {
		super(instance, 552);
	...
	public void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("nowhere_soul"));
	}
