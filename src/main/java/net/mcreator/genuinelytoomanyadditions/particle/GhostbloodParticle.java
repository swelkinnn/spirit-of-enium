...
public class GhostbloodParticle extends SoeModElements.ModElement {
	public static final BasicParticleType particle = new BasicParticleType(false);
	public GhostbloodParticle(SoeModElements instance) {
		super(instance, 821);
	...
	public void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("ghostblood"));
	}
