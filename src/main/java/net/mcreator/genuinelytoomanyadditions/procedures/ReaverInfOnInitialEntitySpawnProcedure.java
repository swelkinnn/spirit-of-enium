...
public class ReaverInfOnInitialEntitySpawnProcedure extends SoeModElements.ModElement {
	public ReaverInfOnInitialEntitySpawnProcedure(SoeModElements instance) {
		super(instance, 904);
	}
