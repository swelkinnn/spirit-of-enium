...
public class VoidSicknessPotionStartedappliedProcedure extends SoeModElements.ModElement {
	public VoidSicknessPotionStartedappliedProcedure(SoeModElements instance) {
		super(instance, 930);
