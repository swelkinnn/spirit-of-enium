...
public class MaaatickProcedure extends SoeModElements.ModElement {
	public MaaatickProcedure(SoeModElements instance) {
		super(instance, 965);
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				SoeMod.LOGGER.warn("Failed to load dependency entity for procedure Maaatick!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				SoeMod.LOGGER.warn("Failed to load dependency world for procedure Maaatick!");
			return;
		}
