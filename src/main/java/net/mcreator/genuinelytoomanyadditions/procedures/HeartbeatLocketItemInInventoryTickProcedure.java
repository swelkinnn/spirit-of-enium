...
import net.mcreator.genuinelytoomanyadditions.potion.DecayPotion;
...
public class HeartbeatLocketItemInInventoryTickProcedure extends SoeModElements.ModElement {
	public HeartbeatLocketItemInInventoryTickProcedure(SoeModElements instance) {
		super(instance, 713);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if ((((entity instanceof LivingEntity) ? ((LivingEntity) entity).getHealth() : -1) >= 20)) {
			...
			if (entity instanceof LivingEntity)
				((LivingEntity) entity).addPotionEffect(new EffectInstance(DecayPotion.potion, (int) 60, (int) 0, (false), (false)));
		}
