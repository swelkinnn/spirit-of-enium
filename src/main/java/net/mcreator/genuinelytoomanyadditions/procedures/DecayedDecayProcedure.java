...
public class DecayedDecayProcedure extends SoeModElements.ModElement {
	public DecayedDecayProcedure(SoeModElements instance) {
		super(instance, 720);
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if ((sourceentity instanceof DecayedEntity.CustomEntity)) {
			if (entity instanceof LivingEntity)
				((LivingEntity) entity).addPotionEffect(new EffectInstance(DecayPotion.potion, (int) 60, (int) 1));
		}
	}
