...
public class AtomicAssimilatorBulletHitsLivingEntityProcedure extends SoeModElements.ModElement {
	public AtomicAssimilatorBulletHitsLivingEntityProcedure(SoeModElements instance) {
		super(instance, 271);
	}
