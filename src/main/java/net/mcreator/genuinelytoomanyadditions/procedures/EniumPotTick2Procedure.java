...
public class EniumPotTick2Procedure extends SoeModElements.ModElement {
	public EniumPotTick2Procedure(SoeModElements instance) {
		super(instance, 378);
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				SoeMod.LOGGER.warn("Failed to load dependency entity for procedure EniumPotTick2!");
			return;
		}
