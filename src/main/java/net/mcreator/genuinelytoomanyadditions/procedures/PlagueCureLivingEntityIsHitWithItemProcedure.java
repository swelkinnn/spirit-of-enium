...
public class PlagueCureLivingEntityIsHitWithItemProcedure extends SoeModElements.ModElement {
	public PlagueCureLivingEntityIsHitWithItemProcedure(SoeModElements instance) {
		super(instance, 770);
	}
