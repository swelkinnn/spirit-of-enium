...
public class FireyGreatswordLivingEntityIsHitWithToolProcedure extends SoeModElements.ModElement {
	public FireyGreatswordLivingEntityIsHitWithToolProcedure(SoeModElements instance) {
		super(instance, 232);
	}
