...
public class WendigoPendantOffRightClickedInAirProcedure extends SoeModElements.ModElement {
	public WendigoPendantOffRightClickedInAirProcedure(SoeModElements instance) {
		super(instance, 907);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				SoeMod.LOGGER.warn("Failed to load dependency entity for procedure WendigoPendantOffRightClickedInAir!");
			return;
		}
