...
public class GodkingPyreRightClickedInAirProcedure extends SoeModElements.ModElement {
	public GodkingPyreRightClickedInAirProcedure(SoeModElements instance) {
		super(instance, 684);
	}
		...
		if ((((entity instanceof PlayerEntity) ? ((PlayerEntity) entity).experienceLevel : 0) >= 5)) {
			...
			if (entity instanceof LivingEntity) {
				...
				if (!_ent.world.isRemote()) {
					VgkflameweaponItem.shoot(_ent.world, (LivingEntity) entity, new Random(), (float) 3.5, (float) 8, (int) 3);
				}
			}
