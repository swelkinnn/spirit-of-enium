...
public class PigmanTradesmanRightClickedOnEntityProcedure extends SoeModElements.ModElement {
	public PigmanTradesmanRightClickedOnEntityProcedure(SoeModElements instance) {
		super(instance, 948);
	}
