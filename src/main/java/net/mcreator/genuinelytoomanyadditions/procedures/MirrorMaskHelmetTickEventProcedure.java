...
public class MirrorMaskHelmetTickEventProcedure extends SoeModElements.ModElement {
	public MirrorMaskHelmetTickEventProcedure(SoeModElements instance) {
		super(instance, 871);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				SoeMod.LOGGER.warn("Failed to load dependency entity for procedure MirrorMaskHelmetTickEvent!");
			return;
		}
