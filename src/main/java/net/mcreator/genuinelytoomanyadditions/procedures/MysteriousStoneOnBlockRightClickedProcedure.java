...
public class MysteriousStoneOnBlockRightClickedProcedure extends SoeModElements.ModElement {
	public MysteriousStoneOnBlockRightClickedProcedure(SoeModElements instance) {
		super(instance, 848);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if ((((entity instanceof LivingEntity) ? ((LivingEntity) entity).getHeldItemMainhand() : ItemStack.EMPTY)
			...
			if (entity instanceof PlayerEntity) {
				ItemStack _setstack = new ItemStack(MercuryBottleItem.block, (int) (1));
