...
public class AlbedoStoneRightClickedOnBlockProcedure extends SoeModElements.ModElement {
	public AlbedoStoneRightClickedOnBlockProcedure(SoeModElements instance) {
		super(instance, 856);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == Blocks.IRON_ORE.getDefaultState().getBlock())) {
			...
			if (entity instanceof PlayerEntity) {
				ItemStack _stktoremove = new ItemStack(AlbedoStoneItem.block, (int) (1));
				((PlayerEntity) entity).inventory.func_234564_a_(p -> _stktoremove.getItem() == p.getItem(), (int) 1,
						((PlayerEntity) entity).container.func_234641_j_());
			}
			if (entity instanceof PlayerEntity) {
				ItemStack _setstack = new ItemStack(CitrinitasStoneItem.block, (int) (1));
