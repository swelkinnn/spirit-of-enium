...
public class VgkflameweaponCanUseRangedItemProcedure extends SoeModElements.ModElement {
	public VgkflameweaponCanUseRangedItemProcedure(SoeModElements instance) {
		super(instance, 678);
	}
