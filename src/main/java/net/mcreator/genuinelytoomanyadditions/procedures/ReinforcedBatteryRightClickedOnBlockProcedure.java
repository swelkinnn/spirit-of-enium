...
public class ReinforcedBatteryRightClickedOnBlockProcedure extends SoeModElements.ModElement {
	public ReinforcedBatteryRightClickedOnBlockProcedure(SoeModElements instance) {
		super(instance, 207);
	}
