		...
		if ((((entity instanceof PlayerEntity) ? ((PlayerEntity) entity).experienceLevel : 0) >= 3)) {
			...
			if (world instanceof World && !world.isRemote()) {
				((World) world).playSound(null, new BlockPos((int) x, (int) y, (int) z),
						(net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.fox.teleport")),
			...
			if (((entity.isSneaking()) && (((entity instanceof PlayerEntity) ? ((PlayerEntity) entity).experienceLevel : 0) >= 5))) {
				if (entity instanceof PlayerEntity)
