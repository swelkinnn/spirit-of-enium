...
public class NightmareLanternSummonerOnBlockRightClickedProcedure extends SoeModElements.ModElement {
	public NightmareLanternSummonerOnBlockRightClickedProcedure(SoeModElements instance) {
		super(instance, 306);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (((entity instanceof PlayerEntity)
				? ((PlayerEntity) entity).inventory.hasItemStack(new ItemStack(GrimmBadgeItem.block, (int) (1)))
				: false)) {
			if (entity instanceof PlayerEntity) {
				ItemStack _stktoremove = new ItemStack(GrimmBadgeItem.block, (int) (1));
		...
		if (((entity instanceof PlayerEntity)
				? ((PlayerEntity) entity).inventory.hasItemStack(new ItemStack(GodkingPinItem.block, (int) (1)))
				: false)) {
			if (entity instanceof PlayerEntity) {
				ItemStack _stktoremove = new ItemStack(GodkingPinItem.block, (int) (1));
				((PlayerEntity) entity).inventory.func_234564_a_(p -> _stktoremove.getItem() == p.getItem(), (int) 1,
						((PlayerEntity) entity).container.func_234641_j_());
			}
			world.setBlockState(new BlockPos((int) x, (int) y, (int) z), Blocks.AIR.getDefaultState(), 3);
