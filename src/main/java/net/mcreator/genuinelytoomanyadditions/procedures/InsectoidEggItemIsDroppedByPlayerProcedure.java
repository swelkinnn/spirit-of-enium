...
public class InsectoidEggItemIsDroppedByPlayerProcedure extends SoeModElements.ModElement {
	public InsectoidEggItemIsDroppedByPlayerProcedure(SoeModElements instance) {
		super(instance, 608);
	}
