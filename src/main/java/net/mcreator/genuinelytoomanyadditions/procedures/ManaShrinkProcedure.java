...
public class ManaShrinkProcedure extends SoeModElements.ModElement {
	public ManaShrinkProcedure(SoeModElements instance) {
		super(instance, 967);
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				SoeMod.LOGGER.warn("Failed to load dependency entity for procedure ManaShrink!");
			return;
		}
