...
public class MirrorMaskDemonHelmetTickEventProcedure extends SoeModElements.ModElement {
	public MirrorMaskDemonHelmetTickEventProcedure(SoeModElements instance) {
		super(instance, 875);
	}
