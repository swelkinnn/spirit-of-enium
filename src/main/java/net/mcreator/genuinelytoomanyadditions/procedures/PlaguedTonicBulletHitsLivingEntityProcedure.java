...
public class PlaguedTonicBulletHitsLivingEntityProcedure extends SoeModElements.ModElement {
	public PlaguedTonicBulletHitsLivingEntityProcedure(SoeModElements instance) {
		super(instance, 589);
	}
