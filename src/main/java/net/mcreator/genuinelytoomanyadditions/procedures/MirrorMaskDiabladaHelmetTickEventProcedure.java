...
public class MirrorMaskDiabladaHelmetTickEventProcedure extends SoeModElements.ModElement {
	public MirrorMaskDiabladaHelmetTickEventProcedure(SoeModElements instance) {
		super(instance, 879);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				SoeMod.LOGGER.warn("Failed to load dependency entity for procedure MirrorMaskDiabladaHelmetTickEvent!");
			return;
		}
