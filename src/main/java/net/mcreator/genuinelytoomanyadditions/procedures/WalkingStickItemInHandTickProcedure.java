...
public class WalkingStickItemInHandTickProcedure extends SoeModElements.ModElement {
	public WalkingStickItemInHandTickProcedure(SoeModElements instance) {
		super(instance, 931);
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if ((((entity instanceof LivingEntity) ? ((LivingEntity) entity).getHeldItemOffhand() : ItemStack.EMPTY)
				.getItem() == new ItemStack(WalkingStickItem.block, (int) (1)).getItem())) {
