...
public class TheLostOnInitialEntitySpawnProcedure extends SoeModElements.ModElement {
	public TheLostOnInitialEntitySpawnProcedure(SoeModElements instance) {
		super(instance, 915);
	}
