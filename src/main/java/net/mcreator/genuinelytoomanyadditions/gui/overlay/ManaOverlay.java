...
import net.mcreator.genuinelytoomanyadditions.procedures.ManaDisplayOverlayIngameProcedure;
...
public class ManaOverlay extends SoeModElements.ModElement {
	public ManaOverlay(SoeModElements instance) {
		super(instance, 970);
	}
