...
import net.mcreator.genuinelytoomanyadditions.procedures.Mana5DisplayOverlayTickProcedure;
...
public class Mana5Overlay extends SoeModElements.ModElement {
	public Mana5Overlay(SoeModElements instance) {
		super(instance, 978);
	}
