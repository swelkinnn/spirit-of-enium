...
import net.mcreator.genuinelytoomanyadditions.entity.renderer.GrimmatureRenderer;
import net.mcreator.genuinelytoomanyadditions.SoeModElements;

import java.util.EnumSet;

@SoeModElements.ModElement.Tag
public class GrimmatureEntity extends SoeModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(0.6f, 1.8f)).build("grimmature").setRegistryName("grimmature");
	public GrimmatureEntity(SoeModElements instance) {
		super(instance, 434);
		FMLJavaModLoadingContext.get().getModEventBus().register(new GrimmatureRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -3407872, -13312, new Item.Properties().group(null)).setRegistryName("grimmature_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity implements IRangedAttackMob {
		...
		public void attackEntityWithRangedAttack(LivingEntity target, float flval) {
			VgkflameweaponItem.shoot(this, target);
		}
