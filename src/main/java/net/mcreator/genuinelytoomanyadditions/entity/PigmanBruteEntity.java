...
import net.mcreator.genuinelytoomanyadditions.entity.renderer.PigmanBruteRenderer;
import net.mcreator.genuinelytoomanyadditions.SoeModElements;

@SoeModElements.ModElement.Tag
public class PigmanBruteEntity extends SoeModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("pigman_brute").setRegistryName("pigman_brute");
	public PigmanBruteEntity(SoeModElements instance) {
		super(instance, 939);
		FMLJavaModLoadingContext.get().getModEventBus().register(new PigmanBruteRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13108, -8847360, new Item.Properties().group(GTMMobsItemGroup.tab))
				.setRegistryName("pigman_brute_spawn_egg"));
	}
	...
	public static class CustomEntity extends CreatureEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			setNoAI(false);
			enablePersistence();
			this.setItemStackToSlot(EquipmentSlotType.MAINHAND, new ItemStack(SteelSwordItem.block, (int) (1)));
