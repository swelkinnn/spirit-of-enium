...
import net.mcreator.genuinelytoomanyadditions.item.NailItem;
import net.mcreator.genuinelytoomanyadditions.entity.renderer.HuskSentryRenderer;
import net.mcreator.genuinelytoomanyadditions.SoeModElements;

@SoeModElements.ModElement.Tag
public class HuskSentryEntity extends SoeModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("husk_sentry").setRegistryName("husk_sentry");
	public HuskSentryEntity(SoeModElements instance) {
		super(instance, 127);
		FMLJavaModLoadingContext.get().getModEventBus().register(new HuskSentryRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -8889393, -3381760, new Item.Properties().group(GTMMobsItemGroup.tab))
				.setRegistryName("husk_sentry_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 2;
			setNoAI(false);
			this.setItemStackToSlot(EquipmentSlotType.MAINHAND, new ItemStack(NailItem.block, (int) (1)));
		}
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(2, new LeapAtTargetGoal(this, (float) 0.75));
