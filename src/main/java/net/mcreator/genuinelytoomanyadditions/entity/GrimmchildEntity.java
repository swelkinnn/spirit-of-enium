...
import net.mcreator.genuinelytoomanyadditions.procedures.GrimmchildRightClickedOnEntityProcedure;
import net.mcreator.genuinelytoomanyadditions.procedures.GrimmchildEntityIsHurtProcedure;
import net.mcreator.genuinelytoomanyadditions.item.NightmareFlameItem;
...
import net.mcreator.genuinelytoomanyadditions.item.GrimmchildSummonerItem;
import net.mcreator.genuinelytoomanyadditions.entity.renderer.GrimmchildRenderer;
...
public class GrimmchildEntity extends SoeModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(0.6f, 1.8f)).build("grimmchild").setRegistryName("grimmchild");
	public GrimmchildEntity(SoeModElements instance) {
		super(instance, 314);
		FMLJavaModLoadingContext.get().getModEventBus().register(new GrimmchildRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -16777216, -65536, new Item.Properties().group(null)).setRegistryName("grimmchild_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity implements IRangedAttackMob {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(2,
					new TemptGoal(this, 1, Ingredient.fromItems(new ItemStack(NightmareFlameItem.block, (int) (1)).getItem()), false));
			this.goalSelector.addGoal(3, new FollowOwnerGoal(this, 1, (float) 3, (float) 2, false));
			this.goalSelector.addGoal(4, new FollowOwnerGoal(this, 1, (float) 3, (float) 2, false));
			this.goalSelector.addGoal(5,
					new TemptGoal(this, 1, Ingredient.fromItems(new ItemStack(InfectedGlobuleItem.block, (int) (1)).getItem()), false));
			this.targetSelector.addGoal(6, new NearestAttackableTargetGoal(this, MonsterEntity.class, false, false));
			this.goalSelector.addGoal(7, new FollowOwnerGoal(this, 1, (float) 3, (float) 2, false));
			this.goalSelector.addGoal(8, new OwnerHurtByTargetGoal(this));
			this.goalSelector.addGoal(9, new OwnerHurtTargetGoal(this));
			this.goalSelector.addGoal(10, new RandomWalkingGoal(this, 0.8, 20) {
				@Override
			...
			this.targetSelector.addGoal(13, new HurtByTargetGoal(this).setCallsForHelp(this.getClass()));
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(GrimmchildSummonerItem.block, (int) (1)));
		}
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity sourceentity = source.getTrueSource();
			{
				...
				GrimmchildEntityIsHurtProcedure.executeProcedure($_dependencies);
			}
		...
		public ActionResultType func_230254_b_(PlayerEntity sourceentity, Hand hand) {
			...
			Entity entity = this;
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				GrimmchildRightClickedOnEntityProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}

		public void attackEntityWithRangedAttack(LivingEntity target, float flval) {
			GrimmflameItem.shoot(this, target);
		}
		...
		public boolean isBreedingItem(ItemStack stack) {
			if (stack == null)
				return false;
			if (new ItemStack(InfectedGlobuleItem.block, (int) (1)).getItem() == stack.getItem())
				return true;
			return false;
		}
