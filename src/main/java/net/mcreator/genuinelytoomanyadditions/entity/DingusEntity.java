	...
	public static class CustomEntity extends TameableEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(1,
					new TemptGoal(this, 1, Ingredient.fromItems(new ItemStack(Items.GLISTERING_MELON_SLICE, (int) (1)).getItem()), false));
			this.goalSelector.addGoal(2, new BreakBlockGoal(Blocks.GRASS.getDefaultState().getBlock(), this, 1, (int) 3));
			this.goalSelector.addGoal(3, new BreakBlockGoal(Blocks.TALL_GRASS.getDefaultState().getBlock(), this, 1, (int) 3));
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(DingusholdItem.block, (int) (1)));
		}
		...
		public boolean isBreedingItem(ItemStack stack) {
			if (stack == null)
				return false;
			if (new ItemStack(Items.GLISTERING_MELON_SLICE, (int) (1)).getItem() == stack.getItem())
				return true;
			return false;
		}
