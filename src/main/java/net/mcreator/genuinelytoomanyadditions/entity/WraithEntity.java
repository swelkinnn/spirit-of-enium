...
import net.mcreator.genuinelytoomanyadditions.item.WraithlyShankItem;
import net.mcreator.genuinelytoomanyadditions.item.WraithlyArmorItem;
import net.mcreator.genuinelytoomanyadditions.entity.renderer.WraithRenderer;
import net.mcreator.genuinelytoomanyadditions.SoeModElements;

import java.util.Random;

@SoeModElements.ModElement.Tag
public class WraithEntity extends SoeModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(0.6f, 1.8f)).build("wraith").setRegistryName("wraith");
	public WraithEntity(SoeModElements instance) {
		super(instance, 121);
		FMLJavaModLoadingContext.get().getModEventBus().register(new WraithRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -10066330, new Item.Properties().group(GTMMobsItemGroup.tab))
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 3;
			setNoAI(false);
			this.setItemStackToSlot(EquipmentSlotType.MAINHAND, new ItemStack(WraithlyShankItem.block, (int) (1)));
			this.setItemStackToSlot(EquipmentSlotType.HEAD, new ItemStack(WraithlyArmorItem.helmet, (int) (1)));
			this.setItemStackToSlot(EquipmentSlotType.CHEST, new ItemStack(WraithlyArmorItem.body, (int) (1)));
			this.setItemStackToSlot(EquipmentSlotType.LEGS, new ItemStack(WraithlyArmorItem.legs, (int) (1)));
			this.setItemStackToSlot(EquipmentSlotType.FEET, new ItemStack(WraithlyArmorItem.boots, (int) (1)));
		}
		...
		public net.minecraft.util.SoundEvent getAmbientSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS
					.getValue(new ResourceLocation("entity.parrot.imitate.wither_skeleton"));
		}
