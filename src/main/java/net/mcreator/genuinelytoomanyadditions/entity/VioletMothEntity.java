...
import net.mcreator.genuinelytoomanyadditions.procedures.VioletMothEntityDiesProcedure;
...
import net.mcreator.genuinelytoomanyadditions.entity.renderer.VioletMothRenderer;
...
public class VioletMothEntity extends SoeModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("violet_moth").setRegistryName("violet_moth");
	public VioletMothEntity(SoeModElements instance) {
		super(instance, 140);
		FMLJavaModLoadingContext.get().getModEventBus().register(new VioletMothRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -6749953, new Item.Properties().group(GTMMobsItemGroup.tab))
				.setRegistryName("violet_moth_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity implements IRangedAttackMob {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(3, new MeleeAttackGoal(this, 4, false));
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(VioletCloakItem.body, (int) (1)));
		}
		...
		public void onDeath(DamageSource source) {
			...
			Entity entity = this;
			{
				...
				VioletMothEntityDiesProcedure.executeProcedure($_dependencies);
			}
		}
