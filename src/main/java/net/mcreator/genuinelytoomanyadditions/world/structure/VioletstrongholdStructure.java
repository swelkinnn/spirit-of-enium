...
public class VioletstrongholdStructure extends SoeModElements.ModElement {
	private static Feature<NoFeatureConfig> feature = null;
	private static ConfiguredFeature<?, ?> configuredFeature = null;
	public VioletstrongholdStructure(SoeModElements instance) {
		super(instance, 601);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
					...
					if ((random.nextInt(1000000) + 1) <= 1) {
						...
						for (int a = 0; a < count; a++) {
							...
							Template template = world.getWorld().getStructureTemplateManager()
									.getTemplateDefaulted(new ResourceLocation("soe", "violetstronghold"));
							if (template == null)
								return false;
			...
			event.getRegistry().register(feature.setRegistryName("violetstronghold"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("soe:violetstronghold"), configuredFeature);
		}
	}
	@SubscribeEvent
