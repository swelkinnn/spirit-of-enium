...
public class RestingPigmenTentStructure extends SoeModElements.ModElement {
	private static Feature<NoFeatureConfig> feature = null;
	private static ConfiguredFeature<?, ?> configuredFeature = null;
	public RestingPigmenTentStructure(SoeModElements instance) {
		super(instance, 331);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
					...
					if ((random.nextInt(1000000) + 1) <= 2500) {
						...
						for (int a = 0; a < count; a++) {
							...
							Template template = world.getWorld().getStructureTemplateManager()
									.getTemplateDefaulted(new ResourceLocation("soe", "restingpigmentent"));
							if (template == null)
								return false;
			...
			event.getRegistry().register(feature.setRegistryName("resting_pigmen_tent"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("soe:resting_pigmen_tent"), configuredFeature);
		}
	}
	@SubscribeEvent
