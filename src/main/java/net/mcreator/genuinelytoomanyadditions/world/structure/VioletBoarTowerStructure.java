...
public class VioletBoarTowerStructure extends SoeModElements.ModElement {
	private static Feature<NoFeatureConfig> feature = null;
	private static ConfiguredFeature<?, ?> configuredFeature = null;
	public VioletBoarTowerStructure(SoeModElements instance) {
		super(instance, 427);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
					...
					if ((random.nextInt(1000000) + 1) <= 1000) {
						...
						for (int a = 0; a < count; a++) {
							...
							Template template = world.getWorld().getStructureTemplateManager()
									.getTemplateDefaulted(new ResourceLocation("soe", "violetboartower"));
							if (template == null)
								return false;
			...
			event.getRegistry().register(feature.setRegistryName("violet_boar_tower"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("soe:violet_boar_tower"), configuredFeature);
		}
	}
	@SubscribeEvent
