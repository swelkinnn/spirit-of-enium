...
public class IllagerJailStructure extends SoeModElements.ModElement {
	private static Feature<NoFeatureConfig> feature = null;
	private static ConfiguredFeature<?, ?> configuredFeature = null;
	public IllagerJailStructure(SoeModElements instance) {
		super(instance, 257);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
					...
					if ((random.nextInt(1000000) + 1) <= 5000) {
						...
						for (int a = 0; a < count; a++) {
							...
							Template template = world.getWorld().getStructureTemplateManager()
									.getTemplateDefaulted(new ResourceLocation("soe", "illagerjailfixed"));
							if (template == null)
								return false;
			...
			event.getRegistry().register(feature.setRegistryName("illager_jail"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("soe:illager_jail"), configuredFeature);
		}
	}
	@SubscribeEvent
