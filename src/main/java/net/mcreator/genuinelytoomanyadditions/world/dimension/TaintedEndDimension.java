...
public class TaintedEndDimension extends SoeModElements.ModElement {
	public TaintedEndDimension(SoeModElements instance) {
		super(instance, 798);
	}
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("soe:tainted_end"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
