...
public class FadedYellowConcreteBlock extends SoeModElements.ModElement {
	@ObjectHolder("soe:faded_yellow_concrete")
	public static final Block block = null;
	public FadedYellowConcreteBlock(SoeModElements instance) {
		super(instance, 807);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("faded_yellow_concrete");
		}
