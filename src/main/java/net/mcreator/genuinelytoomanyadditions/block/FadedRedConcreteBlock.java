...
public class FadedRedConcreteBlock extends SoeModElements.ModElement {
	@ObjectHolder("soe:faded_red_concrete")
	public static final Block block = null;
	public FadedRedConcreteBlock(SoeModElements instance) {
		super(instance, 806);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("faded_red_concrete");
		}
