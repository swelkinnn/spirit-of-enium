...
public class CrumblingDoorBlock extends SoeModElements.ModElement {
	@ObjectHolder("soe:crumbling_door")
	public static final Block block = null;
	public CrumblingDoorBlock(SoeModElements instance) {
		super(instance, 537);
	}
	...
	public static class CustomBlock extends DoorBlock {
		public CustomBlock() {
			...
			setRegistryName("crumbling_door");
		}
