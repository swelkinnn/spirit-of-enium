...
public class CrumblingOakPlanksBlock extends SoeModElements.ModElement {
	@ObjectHolder("soe:crumbling_oak_planks")
	public static final Block block = null;
	public CrumblingOakPlanksBlock(SoeModElements instance) {
		super(instance, 494);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("crumbling_oak_planks");
		}
