...
public class FadedLightGreyConcreteBlock extends SoeModElements.ModElement {
	@ObjectHolder("soe:faded_light_grey_concrete")
	public static final Block block = null;
	public FadedLightGreyConcreteBlock(SoeModElements instance) {
		super(instance, 803);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("faded_light_grey_concrete");
		}
