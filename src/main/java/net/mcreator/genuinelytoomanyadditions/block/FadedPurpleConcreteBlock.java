...
public class FadedPurpleConcreteBlock extends SoeModElements.ModElement {
	@ObjectHolder("soe:faded_purple_concrete")
	public static final Block block = null;
	public FadedPurpleConcreteBlock(SoeModElements instance) {
		super(instance, 804);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("faded_purple_concrete");
		}
