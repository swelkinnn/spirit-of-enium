...
public class FadedPinkConcreteBlock extends SoeModElements.ModElement {
	@ObjectHolder("soe:faded_pink_concrete")
	public static final Block block = null;
	public FadedPinkConcreteBlock(SoeModElements instance) {
		super(instance, 813);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("faded_pink_concrete");
		}
