...
public class FadedCyanConcreteBlock extends SoeModElements.ModElement {
	@ObjectHolder("soe:faded_cyan_concrete")
	public static final Block block = null;
	public FadedCyanConcreteBlock(SoeModElements instance) {
		super(instance, 810);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("faded_cyan_concrete");
		}
