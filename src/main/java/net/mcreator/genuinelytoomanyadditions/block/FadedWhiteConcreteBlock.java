...
public class FadedWhiteConcreteBlock extends SoeModElements.ModElement {
	@ObjectHolder("soe:faded_white_concrete")
	public static final Block block = null;
	public FadedWhiteConcreteBlock(SoeModElements instance) {
		super(instance, 814);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("faded_white_concrete");
		}
