...
public class RubyBlockBlock extends SoeModElements.ModElement {
	@ObjectHolder("soe:ruby_block")
	public static final Block block = null;
	public RubyBlockBlock(SoeModElements instance) {
		super(instance, 941);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(51f, 6f).setLightLevel(s -> 0));
