...
public class Hellstonewall2Block extends SoeModElements.ModElement {
	@ObjectHolder("soe:hellstonewall_2")
	public static final Block block = null;
	public Hellstonewall2Block(SoeModElements instance) {
		super(instance, 73);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("hellstonewall_2");
		}
