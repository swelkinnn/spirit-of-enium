...
public class CandycaneWallBlock extends SoeModElements.ModElement {
	@ObjectHolder("soe:candycane_wall")
	public static final Block block = null;
	public CandycaneWallBlock(SoeModElements instance) {
		super(instance, 99);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("candycane_wall");
		}
