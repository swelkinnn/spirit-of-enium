...
public class FadedLimeConcreteBlock extends SoeModElements.ModElement {
	@ObjectHolder("soe:faded_lime_concrete")
	public static final Block block = null;
	public FadedLimeConcreteBlock(SoeModElements instance) {
		super(instance, 811);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("faded_lime_concrete");
		}
