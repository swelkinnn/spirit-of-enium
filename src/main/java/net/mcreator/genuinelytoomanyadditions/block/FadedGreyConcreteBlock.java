...
public class FadedGreyConcreteBlock extends SoeModElements.ModElement {
	@ObjectHolder("soe:faded_grey_concrete")
	public static final Block block = null;
	public FadedGreyConcreteBlock(SoeModElements instance) {
		super(instance, 802);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("faded_grey_concrete");
		}
