...
public class CandycaneblockBlock extends SoeModElements.ModElement {
	@ObjectHolder("soe:candycaneblock")
	public static final Block block = null;
	public CandycaneblockBlock(SoeModElements instance) {
		super(instance, 96);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("candycaneblock");
		}
