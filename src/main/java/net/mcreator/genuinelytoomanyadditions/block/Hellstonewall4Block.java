...
public class Hellstonewall4Block extends SoeModElements.ModElement {
	@ObjectHolder("soe:hellstonewall_4")
	public static final Block block = null;
	public Hellstonewall4Block(SoeModElements instance) {
		super(instance, 75);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("hellstonewall_4");
		}
