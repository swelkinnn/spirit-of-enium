...
public class CyanFloweBlock extends SoeModElements.ModElement {
	@ObjectHolder("soe:cyan_flowe")
	public static final Block block = null;
	public CyanFloweBlock(SoeModElements instance) {
		super(instance, 143);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("cyan_flowe"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("soe:cyan_flowe"), configuredFeature);
		}
	}
	@SubscribeEvent
