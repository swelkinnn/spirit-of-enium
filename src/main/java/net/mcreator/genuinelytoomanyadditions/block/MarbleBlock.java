...
public class MarbleBlock extends SoeModElements.ModElement {
	@ObjectHolder("soe:marble")
	public static final Block block = null;
	public MarbleBlock(SoeModElements instance) {
		super(instance, 639);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("soe:marble_match"), () -> CustomRuleTest.codec);
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("soe:marble"), configuredFeature);
		}
	}
	@SubscribeEvent
