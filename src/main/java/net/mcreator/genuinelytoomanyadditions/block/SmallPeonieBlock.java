...
public class SmallPeonieBlock extends SoeModElements.ModElement {
	@ObjectHolder("soe:small_peonie")
	public static final Block block = null;
	public SmallPeonieBlock(SoeModElements instance) {
		super(instance, 144);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("small_peonie"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("soe:small_peonie"), configuredFeature);
		}
	}
	@SubscribeEvent
