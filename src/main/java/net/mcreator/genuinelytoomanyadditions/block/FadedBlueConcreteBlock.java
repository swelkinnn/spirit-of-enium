...
public class FadedBlueConcreteBlock extends SoeModElements.ModElement {
	@ObjectHolder("soe:faded_blue_concrete")
	public static final Block block = null;
	public FadedBlueConcreteBlock(SoeModElements instance) {
		super(instance, 801);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("faded_blue_concrete");
		}
