...
public class GingerbreadWallBlock extends SoeModElements.ModElement {
	@ObjectHolder("soe:gingerbread_wall")
	public static final Block block = null;
	public GingerbreadWallBlock(SoeModElements instance) {
		super(instance, 94);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(2f, 3f).setLightLevel(s -> 0).notSolid()
					.setOpaque((bs, br, bp) -> false));
			setRegistryName("gingerbread_wall");
		}
