...
public class RoseBlock extends SoeModElements.ModElement {
	@ObjectHolder("soe:rose")
	public static final Block block = null;
	public RoseBlock(SoeModElements instance) {
		super(instance, 142);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("rose"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("soe:rose"), configuredFeature);
		}
	}
	@SubscribeEvent
