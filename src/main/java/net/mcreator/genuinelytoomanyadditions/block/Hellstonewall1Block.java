...
public class Hellstonewall1Block extends SoeModElements.ModElement {
	@ObjectHolder("soe:hellstonewall_1")
	public static final Block block = null;
	public Hellstonewall1Block(SoeModElements instance) {
		super(instance, 72);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("hellstonewall_1");
		}
