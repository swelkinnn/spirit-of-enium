...
public class FadedBrownConcreteBlock extends SoeModElements.ModElement {
	@ObjectHolder("soe:faded_brown_concrete")
	public static final Block block = null;
	public FadedBrownConcreteBlock(SoeModElements instance) {
		super(instance, 809);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("faded_brown_concrete");
		}
