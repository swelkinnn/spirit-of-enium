...
public class FadedLightBlueConcreteBlock extends SoeModElements.ModElement {
	@ObjectHolder("soe:faded_light_blue_concrete")
	public static final Block block = null;
	public FadedLightBlueConcreteBlock(SoeModElements instance) {
		super(instance, 815);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("faded_light_blue_concrete");
		}
