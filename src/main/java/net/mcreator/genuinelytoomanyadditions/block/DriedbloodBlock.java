...
public class DriedbloodBlock extends SoeModElements.ModElement {
	@ObjectHolder("soe:driedblood")
	public static final Block block = null;
	public DriedbloodBlock(SoeModElements instance) {
		super(instance, 489);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(0f, 0f).setLightLevel(s -> 0)
					.doesNotBlockMovement().slipperiness(1.2000000000000002f).notSolid().setOpaque((bs, br, bp) -> false));
			this.setDefaultState(this.stateContainer.getBaseState().with(WATERLOGGED, false));
			setRegistryName("driedblood");
		}
