...
public class LavendariumMeshSheetBlock extends SoeModElements.ModElement {
	@ObjectHolder("soe:lavendarium_mesh_sheet")
	public static final Block block = null;
	public LavendariumMeshSheetBlock(SoeModElements instance) {
		super(instance, 65);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("lavendarium_mesh_sheet");
		}
