...
public class Gingerbread_blocksPlanksBlock extends SoeModElements.ModElement {
	@ObjectHolder("soe:gingerbread_block")
	public static final Block block = null;
	public Gingerbread_blocksPlanksBlock(SoeModElements instance) {
		super(instance, 89);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("gingerbread_block");
		}
