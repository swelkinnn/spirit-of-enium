...
public class FadedBlackConcreteBlock extends SoeModElements.ModElement {
	@ObjectHolder("soe:faded_black_concrete")
	public static final Block block = null;
	public FadedBlackConcreteBlock(SoeModElements instance) {
		super(instance, 808);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("faded_black_concrete");
		}
