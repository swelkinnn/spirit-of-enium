...
public class FadedMagentaConcreteBlock extends SoeModElements.ModElement {
	@ObjectHolder("soe:faded_magenta_concrete")
	public static final Block block = null;
	public FadedMagentaConcreteBlock(SoeModElements instance) {
		super(instance, 812);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("faded_magenta_concrete");
		}
