...
import net.mcreator.genuinelytoomanyadditions.procedures.PresentBlockDestroyedByPlayerProcedure;
...
public class PresentBlock extends SoeModElements.ModElement {
	@ObjectHolder("soe:present")
	public static final Block block = null;
	public PresentBlock(SoeModElements instance) {
		super(instance, 478);
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public boolean removedByPlayer(BlockState state, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			int z = pos.getZ();
			{
				...
				PresentBlockDestroyedByPlayerProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("soe:present_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("present"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("soe:present"), configuredFeature);
		}
	}
	@SubscribeEvent
