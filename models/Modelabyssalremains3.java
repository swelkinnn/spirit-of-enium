...
public static class Modelabyssalremains3 extends EntityModel<Entity> {
	...
	public Modelabyssalremains3() {
		textureWidth = 64;
		textureHeight = 64;

		Head = new ModelRenderer(this);
		Head.setRotationPoint(2.0F, -1.0F, 0.0F);
		setRotationAngle(Head, -0.6109F, 0.0F, -0.1745F);
		Head.setTextureOffset(0, 0).addBox(-6.0F, -7.0F, -4.0F, 8.0F, 8.0F, 8.0F, 0.0F, false);
		...
		setRotationAngle(RightArm, 0.0F, 0.3927F, 0.0F);
